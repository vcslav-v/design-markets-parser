...
echo "from fastapi import FastAPI" >> $(APP_NAME)/fastapi.py
echo "from $(APP_NAME).api.routes import routes" >> $(APP_NAME)/fastapi.py
echo "" >> $(APP_NAME)/fastapi.py
echo "app = FastAPI(debug=True)" >> $(APP_NAME)/fastapi.py
echo "" >> $(APP_NAME)/fastapi.py
echo "app.include_router(routes)" >> $(APP_NAME)/fastapi.py
